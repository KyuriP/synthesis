...
## variance plots
modelplot(mammalsleep, lm.formula = sws ~ log10(bw) + odi, print=TRUE)

modelplot(mammalsleep, lm.formula = sws ~ log10(bw) + odi, seed=123)

modelplot(mammalsleep, lm.formula = sws ~ log10(bw) + odi, seed=124)

modelplot(mammalsleep, imp.method = "mean", lm.formula = sws ~ log10(bw) + odi, seed=124)
